...
# no need of rotary module for transformers has supported it
...
# xkp: 2023/8/13 add implementation of Flash Attention
# set abled when initiating the model
# reference to togethercomputer's implementation    
